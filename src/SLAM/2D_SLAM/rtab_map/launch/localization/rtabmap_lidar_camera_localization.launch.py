"""RTAB-Map Gazebo 2D LiDAR + Camera Localization / 가제보 시뮬레이션용"""
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('database_path', default_value=default_db_path, description='Path to rtabmap database file (.db)'),
