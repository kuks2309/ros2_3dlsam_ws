"""
SLAM Toolbox Gazebo Localization

가제보 시뮬레이션용.

Usage:
    ros2 launch slam_2d slam_toolbox_localization_gazebo.launch.py map_file:=/path/to/map.posegraph
"""
...
def generate_launch_description():
    ...
    default_params_file = os.path.join(pkg_src, 'config', 'mapper_params_localization.yaml')
