"""
RTAB-Map RGB-D Localization Launch File (Real Robot)

This launch file is for localization using RGB-D camera on real robot.
...
def generate_launch_description():
    """Generate launch description for RGB-D localization on real robot."""
    ...
    # RTABMAP Localization node (RGB-D only, localization mode)
    rtabmap_loc = Node(
