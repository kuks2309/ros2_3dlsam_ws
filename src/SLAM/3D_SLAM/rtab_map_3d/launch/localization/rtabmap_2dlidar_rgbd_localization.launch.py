"""
RTAB-Map 2D LiDAR + RGB-D Localization Launch File (Real Robot)

This launch file is for localization using both 2D LiDAR and RGB-D camera on real robot.
...
def generate_launch_description():
    """Generate launch description for 2D LiDAR + RGB-D localization on real robot."""
    ...
    rtabmap_loc = Node(
        ...
        parameters=[{
            ...
            'queue_size': 30,
            # Grid/Map parameters
            'Grid/Sensor': '1',  # Force point cloud projection (not laser scan only)
            # LOCALIZATION MODE
            ...
            # Registration
            'Reg/Strategy': '2',  # ICP for localization
            'Reg/Force3DoF': 'false',
            # Visual features
            'Vis/MinInliers': '15',
