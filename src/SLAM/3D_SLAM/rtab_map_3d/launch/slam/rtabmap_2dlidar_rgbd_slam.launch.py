"""
RTAB-Map 2D LiDAR + RGB-D Mapping Launch File (Real Robot)

This launch file is for SLAM using both 2D LiDAR and RGB-D camera on real robot.
...
def generate_launch_description():
    """Generate launch description for 2D LiDAR + RGB-D SLAM on real robot."""
